"""D17 Evidence-Preserving Pixel GNN."""
...
from d17.models.edge_context_gnn import EdgeContextGNNEncoder
from d17.models.readout import GatedGlobalReadout


class EPPGNN(torch.nn.Module):
    def __init__(
        self,
        input_dim: int = 10,
        edge_attr_dim: int = 6,
    ...
    @classmethod
    def from_config(cls, cfg: Dict[str, Any], input_dim: int = 10, edge_attr_dim: int = 6) -> "EPPGNN":
