"""Batch collation for D18 variable-size pixel graphs."""
...
from d18.data.structure_graph_builder import D18GraphData
...
class D18Batch:
    ...
    def to(self, device: torch.device | str) -> "D18Batch":
        return D18Batch(
