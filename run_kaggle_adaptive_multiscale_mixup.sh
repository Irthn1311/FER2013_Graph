...
echo "============================================================================"
echo "🚀 [RUNNER] FER2013 Pure Pixel Adaptive Multi-Scale Motif GNN + Graph Mixup"
echo "           - 9D Features: [I, x, y, gx, gy, grad_mag, laplacian, local_var, lbp]"
echo "           - Pure Pixel Graph Mixup Augmentation (alpha=0.2, p=0.5)"
...
CONFIG="${1:-standalone/pixel_gnn/configs/fer2013_pixel_motif_adaptive_multiscale_9d_mixup_seed42.yaml}"

if [ -d "/kaggle/working" ]; then
    DEFAULT_OUTPUT="/kaggle/working/outputs/pixel_motif_adaptive_multiscale_mixup_180ep"
else
    DEFAULT_OUTPUT="outputs/pixel_motif_adaptive_multiscale_mixup_180ep"
fi
...
echo ""
echo "🏋️ [STEP 2/3] Launching Pure Pixel Adaptive Multi-Scale Training with Mixup..."
...
echo ""
echo "============================================================================"
echo "🎉 [COMPLETED] Pure Pixel Adaptive Multi-Scale + Mixup Pipeline finished!"
