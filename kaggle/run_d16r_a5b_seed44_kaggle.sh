...
echo "[A5b-seed44] Python/PyTorch/CUDA"
python - <<'PY'
import sys
import torch
...
CONFIG="configs/d16/main_branch/d16r_a5b_heavy_opt_a4_ce_seed44_accmon_150.yaml"
PRIOR_DIR="outputs/d16_mediapipe_pixel_priors_best_retry_rescue"
OUTPUT_DIR="outputs/d16_runs/main_branch/d16r_a5b_heavy_opt_a4_ce_seed44_accmon_150"
CHECK_DIR="outputs/d16_analysis/main_branch/d16r_a5b_heavy_opt_a4_ce_seed44_accmon_150_edge_context_gnn_check"
...
RESUME_ARGS=()
if [[ -f "$LAST_CKPT" ]]; then
  echo "[A5b-seed44] Auto-resuming from ${LAST_CKPT}"
  RESUME_ARGS=(--resume_from "$LAST_CKPT" --resume_strict true)
else
  echo "[A5b-seed44] No last.pt found; starting from scratch"
fi
...
echo "[A5b-seed44] Done: ${OUTPUT_DIR}"
