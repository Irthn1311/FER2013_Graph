...
CANONICAL_FIT_WRAPPER_SHA = "0b030632db66ba7e8fe47c1240f1a27e412b9ef4"
...
def main() -> int:
    ...
    summary = aggregate(public_labels, public_ids, found["m0_L_prediction.npz"][0], [found[f"m0_M_seed_{s}.npz"][0] for s in range(42,47)], [found[f"m0_G_seed_{s}.npz"][0] for s in range(42,47)], output, scientific_sha=SCIENTIFIC_SHA, wrapper_sha=CANONICAL_FIT_WRAPPER_SHA, substrate_sha=substrate.manifest["substrate_sha256"])
    ...
    environment = {"python": sys.version, "platform": platform.platform(), "scientific_sha": SCIENTIFIC_SHA, "execution_wrapper_sha": CANONICAL_FIT_WRAPPER_SHA, "aggregation_orchestration_sha": actual_wrapper_sha, "model_fits_executed": 0, "private_test_read": False}
