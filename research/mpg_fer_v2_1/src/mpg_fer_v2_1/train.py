"""EMA-selected training and exact epoch-boundary continuation for MPG-FER v2.1."""
...
def run_training(
    ...
    if resume_path is not None:
        ...
        print("RESUMING EXISTING MPG-FER v2.1 RUN")
    ...
    print(f"Starting MPG-FER v2.1 training on device: {device}; run_id={run_id}")
