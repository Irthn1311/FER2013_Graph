...
from mpg_fer_v2_1.model import DropPath, EdgeAwarePixelGNNLayer, MPGFER, masked_neighbor_softmax


def test_v2_1_parameter_count_is_only_supcon_delta_from_v2() -> None:
