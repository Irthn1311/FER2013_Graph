"""Generate the source-locked fresh/resume MPG-FER v2.1 Kaggle notebook."""
...
SOURCE_ROOT = PROJECT_ROOT / "src" / "mpg_fer_v2_1"
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "MPG_FER_v2_1_Kaggle_T4.ipynb"
SOURCE_FILES = (
...
def build_notebook() -> dict:
    ...
    bootstrap = f'''# Generated from reviewed Issue #93 sources. Do not hand-edit embedded code.
import sys
from pathlib import Path

EMBEDDED_SOURCES = {sources!r}
EMBEDDED_ROOT = Path("/kaggle/working/mpg_fer_v2_1_embedded")
EMBEDDED_PACKAGE = EMBEDDED_ROOT / "mpg_fer_v2_1"
...
print(f"Materialized reviewed MPG-FER v2.1 package at {{EMBEDDED_PACKAGE}}")
'''
    cells = [
        _markdown(
            "# MPG-FER v2.1 — source-locked segmented Kaggle T4 candidate\n\n"
            "Generated from Issue #93 reviewed sources. The scientific package is "
...
SEGMENT_NUMBER = 1
OUTPUT_DIR = "/kaggle/working/mpg_fer_v2_1_run"
ACCOUNT = "irthn1311"
KERNEL_REF = "irthn1311/mpg-fer-v2-1-t4-review-candidate"
GIT_COMMIT_SHA = "SET_BY_STAGING"
EXPECTED_SOURCE_SHA = "d86d93655c83810d36c89a632baee0745f1de0f0e701b762b719d44445a6e679"
EXPECTED_PARAMETERS = 2_304_528
'''
        ),
        _code(bootstrap),
        _code(
            '''# Environment, source/model/data gates, and explicit v2.1-only resume resolution.
...
from mpg_fer_v2_1.checkpoint import config_hash, load_resume_bundle, sha256_file
from mpg_fer_v2_1.config import MPGConfig
from mpg_fer_v2_1.data import FER2013Dataset, validate_dataset_gate
from mpg_fer_v2_1.ema import ModelEMA
from mpg_fer_v2_1.kaggle import resolve_kaggle_splits, resolve_resume_artifact
...
archive = shutil.make_archive("/kaggle/working/mpg_fer_v2_1_artifacts", "zip", root_dir=output_dir)
...
'''
    ...
    return {
        ...
        "metadata": {
            ...
            "mpg_fer_v2_1_source_manifest": hashes,
            "mpg_fer_v2_1_issue": 93,
