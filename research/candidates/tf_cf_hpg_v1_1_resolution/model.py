"""CF-HPG v1.1 Resolution: finer raw patches with frozen graph semantics."""
...
@tf.keras.utils.register_keras_serializable(package="fer2013_graph_research")
class CFHPGResolution(tf.keras.Model):
    """Registered resolution-only Generation-2 hierarchical patch graph."""
...
def build_cf_hpg_v1_1_resolution() -> CFHPGResolution:
    model = CFHPGResolution(name="cf_hpg_v1_1_resolution")
