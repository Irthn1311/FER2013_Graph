"""CF-HPG v1.2 Tokenizer: deeper raw-patch encoding with frozen graphs."""
...
@tf.keras.utils.register_keras_serializable(package="fer2013_graph_research")
class CFHPGTokenizer(tf.keras.Model):
    """Registered tokenizer-only Generation-2 hierarchical patch graph."""
...
def build_cf_hpg_v1_2_tokenizer() -> CFHPGTokenizer:
    model = CFHPGTokenizer(name="cf_hpg_v1_2_tokenizer")
