"""Generate the source-locked fresh/resume MPG-FER v2.2 Kaggle notebook."""
...
SOURCE_ROOT = PROJECT_ROOT / "src" / "mpg_fer_v2_2"
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "MPG_FER_v2_2_Kaggle_T4.ipynb"
SOURCE_FILES = (
...
'''
    ...
    return {
        ...
        "metadata": {
            ...
            "mpg_fer_v2_2_source_manifest": hashes,
            "mpg_fer_v2_2_issue": 95,
