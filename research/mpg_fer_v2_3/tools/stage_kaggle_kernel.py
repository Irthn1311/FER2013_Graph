...
NOTEBOOK = PROJECT_ROOT / "notebooks" / "MPG_FER_v2_3_Kaggle_T4.ipynb"
...
def main() -> None:
    ...
    notebook_name = "MPG_FER_v2_3_Kaggle_T4.ipynb"
    notebook_path = args.output_dir / notebook_name
    notebook_path.write_text(json.dumps(notebook, indent=1) + "\n", encoding="utf-8")
    owner, slug = args.kernel_ref.split("/", 1)
    metadata = {
        "id": args.kernel_ref,
        "title": f"MPG-FER v2.3 official T4 segment {args.segment:02d}",
