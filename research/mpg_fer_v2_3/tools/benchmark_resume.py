"""Measure full v2.3 resume serialization, hashing, and load overhead locally."""
...
from mpg_fer_v2_3.train import WarmupCosineScheduler, source_tree_hash
...
def main() -> None:
    ...
    if args.output_dir is None:
        temporary_context = tempfile.TemporaryDirectory(prefix="mpg-fer-v2-3-resume-")
