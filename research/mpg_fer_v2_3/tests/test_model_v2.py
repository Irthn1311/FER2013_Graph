...
from mpg_fer_v2_3.model import DropPath, EdgeAwarePixelGNNLayer, MPGFER, masked_neighbor_softmax


def test_v2_3_parameter_count_matches_frozen_v2_2() -> None:
...
def test_full_model_shapes_and_required_diagnostics() -> None:
    ...
    assert tuple(
        float(outputs[f"motif_l{layer}_residual_scale"])
