...
from mpg_fer_v2_3.data import EpochRandomSampler
from mpg_fer_v2_3.ema import ModelEMA
from mpg_fer_v2_3.losses import supervised_contrastive_loss, symmetric_js_divergence
from mpg_fer_v2_3.model import DropPath
from mpg_fer_v2_3.motif import SpatialMotifComposer
...
class TinyActualV21(nn.Module):
    """Compact harness using actual v2.3 motif, tau, MI, DropPath and SupCon."""
...
def test_actual_v2_3_stochastic_multiworker_trajectory_is_resume_invariant(tmp_path) -> None:
...
def test_actual_v2_3_epoch_84_to_85_resume_boundary_is_invariant(tmp_path) -> None:
    config = MPGConfig(gradient_accumulation_steps=1)
    all_epochs = [84, 85, 86]
    first_epochs = [84]
