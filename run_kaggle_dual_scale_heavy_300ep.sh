...
echo "============================================================================"
echo "🔥 [RUNNER] FER2013 HEAVY Dual-Scale GNN (~3.2M Params, 300 Epochs)"
...
CONFIG="${1:-standalone/pixel_gnn/configs/fer2013_pixel_motif_dual_scale_heavy_300ep_seed42.yaml}"
...
# STEP 2: 300-Epoch Heavy Training + Top-5 Checkpoints + Validation-Tuned TTA & Ensemble Sweep
echo ""
echo "🏋️ [STEP 2/3] Launching Heavy Training Pipeline..."
